...
import { Users, Plus, Pencil, Trash2, Car, Wrench } from '@lucide/vue'
...
<template>
  <AppShell title="Pessoas" subtitle="Gerencie as pessoas cadastradas.">
    <template #actions>
      <BaseButton v-if="people.length" @click="openNewPerson">
        <Plus :size="16" />
        Nova pessoa
      </BaseButton>
    </template>
    ...
    <div v-else class="overflow-hidden rounded-2xl border border-ink-100">
